...
class NoteDetector(ft.Text):
  ...
  def start(self, current_note_to_find=None, callback_note_found=None):
    self.running = True
    self.current_note = None
    self.current_note_to_find = current_note_to_find
    self.callback_note_found = callback_note_found
    self.page.run_task(self.listen_audio)
